...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->splitContainer1->Size = System::Drawing::Size(835, 441);
			...
			this->webBrowser1->Size = System::Drawing::Size(553, 441);
			this->webBrowser1->TabIndex = 0;
			this->webBrowser1->Url = (gcnew System::Uri(L"https://map.baidu.com/", System::UriKind::Absolute));
			this->webBrowser1->DocumentCompleted += gcnew System::Windows::Forms::WebBrowserDocumentCompletedEventHandler(this, &LocationForm::webBrowser1_DocumentCompleted);
			// 
			// textBox1
			// 
			...
			this->ClientSize = System::Drawing::Size(835, 441);
